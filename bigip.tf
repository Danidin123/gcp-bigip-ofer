...
# Reserve IPs on internal subnet for BIG-IP 1 nic5
resource "google_compute_address" "int1-4" {
  name         = format("%s-bigip-int4-%s", var.projectPrefix, random_id.buildSuffix.hex)
  subnetwork   = var.intSubnet4
  address_type = "INTERNAL"
  region       = replace(var.gcp_zone_1, "/-[a-z]$/", "")
}
...
# Reserve IPs on internal subnet for BIG-IP 2 nic5
resource "google_compute_address" "int2-4" {
  name         = format("%s-bigip2-int4-%s", var.projectPrefix, random_id.buildSuffix.hex)
  subnetwork   = var.intSubnet4
  address_type = "INTERNAL"
  region       = replace(var.gcp_zone_2, "/-[a-z]$/", "")
}
...
module "bigip" {
  ...
  mgmt_subnet_ids                   = [{ "subnet_id" = var.mgmtSubnet, "public_ip" = false, "private_ip_primary" = google_compute_address.mgt.address }]
  external_subnet_ids               = [{ "subnet_id" = var.extSubnet, "public_ip" = false, "private_ip_primary" = google_compute_address.ext.address, "private_ip_secondary" = google_compute_address.vip.address }]
  internal_subnet_ids               = [{ "subnet_id" = var.intSubnet, "public_ip" = false, "private_ip_primary" = google_compute_address.int.address, "private_ip_secondary" = "" }, { "subnet_id" = var.intSubnet2, "public_ip" = false, "private_ip_primary" = google_compute_address.int1-2.address, "private_ip_secondary" = "" }, { "subnet_id" = var.intSubnet3, "public_ip" = false, "private_ip_primary" = google_compute_address.int1-3.address, "private_ip_secondary" = "" }, { "subnet_id" = var.intSubnet4, "public_ip" = false, "private_ip_primary" = google_compute_address.int1-4.address, "private_ip_secondary" = "" }]
  zone                              = var.gcp_zone_1
...
module "bigip2" {
  ...
  f5_username                       = var.f5_username
  f5_ssh_publickey                  = var.ssh_key
  mgmt_subnet_ids                   = [{ "subnet_id" = var.mgmtSubnet, "public_ip" = false, "private_ip_primary" = google_compute_address.mgt2.address }]
  external_subnet_ids               = [{ "subnet_id" = var.extSubnet, "public_ip" = false, "private_ip_primary" = google_compute_address.ext2.address, "private_ip_secondary" = "" }]
  internal_subnet_ids               = [{ "subnet_id" = var.intSubnet, "public_ip" = false, "private_ip_primary" = google_compute_address.int2.address, "private_ip_secondary" = "" }, { "subnet_id" = var.intSubnet2, "public_ip" = false, "private_ip_primary" = google_compute_address.int2-2.address, "private_ip_secondary" = "" }, { "subnet_id" = var.intSubnet3, "public_ip" = false, "private_ip_primary" = google_compute_address.int2-3.address, "private_ip_secondary" = "" }, { "subnet_id" = var.intSubnet4, "public_ip" = false, "private_ip_primary" = google_compute_address.int2-4.address, "private_ip_secondary" = "" }]
  zone                              = var.gcp_zone_2
